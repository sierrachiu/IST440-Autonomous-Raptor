package edu.psu.ab.ist.sworks.blockchain;
...
public class Block {
    ...
    public String calculateHash() {
        String calculatedhash = edu.psu.ab.ist.sworks.blockchain.StringUtil.applySha256(
                previousHash +
    ...
    public void mineBlock(int difficulty) {
        ...
        String target = edu.psu.ab.ist.sworks.blockchain.StringUtil.getDificultyString(difficulty); //Create a string with difficulty * "0"
