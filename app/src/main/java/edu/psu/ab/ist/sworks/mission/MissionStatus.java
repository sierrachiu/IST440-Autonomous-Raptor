...
public class MissionStatus {
    ...
    public static final String EXTRA_REPLY
            = "com.example.android.sworks.extra.REPLY";
    ...
    public static int getBatteryPrct (Context context) throws MissionStatusException {
        Log.d(LOG_TAG, "Getting battery percentage");
